...
def GLM(sub, task, run):
    ...
    assert len(condition_names) == 16  # 16 = 8 + 8 (feedback)
    ...
    templates = {
        ...
        'mc_param': '/home/ken/projects/brain_data/glm_run-estimate/mc_params/sub-{sub}_task-{task}_run-{run}_mc_params.tsv',
    }
